...
### /src/main/java/com/codewithheeren/springboot/myfirstwebapp/Step23Application.java
...
// Adding a Navigation Bar and Implementing Fragments.
// Adding project lombok in pojo classes.
// Implements builder degine pattern.
@SpringBootApplication
@ComponentScan("com.codewithheeren")
public class Step23Application {

	public static void main(String[] args) {
		SpringApplication.run(Step23Application.class, args);
	}
}
```
---
