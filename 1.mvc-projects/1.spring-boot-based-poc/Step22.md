...
### /src/main/java/com/codewithheeren/springboot/myfirstwebapp/Step22Application.java
...
//update option has been added.

@SpringBootApplication
@ComponentScan("com.codewithheeren")
public class Step22Application {

	public static void main(String[] args) {
		SpringApplication.run(Step22Application.class, args);
	}
}
...
### /src/test/java/com/codewithheeren/springboot/myfirstwebapp/Step22ApplicationTests.java
