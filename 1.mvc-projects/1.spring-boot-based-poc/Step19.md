...
### /src/main/java/com/codewithheeren/springboot/myfirstwebapp/Step19Application.java
...
<body>
	<div class="container">
		...
		<form method="post" th:action="@{/add-todo}" th:object="${todo}">
			...
			Description: <input type="text" placeholder="Enter Task Description"
				required="required" th:field="*{description}" />
			<div class="text-warning" th:if="${#fields.hasErrors('description')}"
				th:errors="*{description}"></div>
			<input type="hidden" th:field="*{id}" /> <input type="hidden"
				th:field="*{done}" /> <input type="submit" class="btn btn-success" />
		</form>
